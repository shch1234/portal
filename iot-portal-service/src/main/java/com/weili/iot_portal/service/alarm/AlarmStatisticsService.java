...
public interface AlarmStatisticsService {
     ...
     * @return 当前报警设备数量
     */
    CurrentAlarmDeviceCountVO getCurrentAlarmDeviceCount(String factoryId, String workshopId);
     ...
     * @return 分页结果
     */
    PageResult<AlarmDeviceItemVO> getCurrentAlarmDeviceList(CurrentAlarmDeviceQueryReq request);
}
