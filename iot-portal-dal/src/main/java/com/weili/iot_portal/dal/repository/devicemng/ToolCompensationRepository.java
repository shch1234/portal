...
public interface ToolCompensationRepository {
     ...
     * 查询当前有效的刀补记录
     */
    ToolCompensationDO findActive(String deviceId, String toolHolderNo);

    /**
     * 查询设备的所有有效刀补记录（可按工厂过滤）
     */
    java.util.List<ToolCompensationDO> findActiveByDevice(String factoryId, String deviceId);
