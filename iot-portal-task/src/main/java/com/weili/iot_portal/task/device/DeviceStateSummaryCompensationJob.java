...
public class DeviceStateSummaryCompensationJob extends BaseCompensationJob<DeviceStateSummaryDO> {
    ...
    public boolean recalculateSummary(DeviceStateSummaryDO summary) {
        ...
        Optional<DeviceShiftConfigDO> configOpt =
                deviceShiftConfigRepository.findActiveByDeviceAndTime(
        ...
        // 重新计算状态统计
        Map<String, DeviceStateSummaryJob.StateStatistics> stateStats =
