...
public class DashboardController {
    ...
    @Parameter(name = "factoryId", description = "工厂ID", example = "123456789")
    public CommonResult<DeviceStateStatisticsRespVO> getDeviceStateStatistics(@RequestParam(value = "factoryId") Long factoryId) {
        DeviceStateStatisticsRespVO statistics = dashboardService.getDeviceStateStatistics(factoryId);
    ...
    public CommonResult<List<AlarmDurationTopRespVO>> getAlarmDurationTop(
        ...
        List<AlarmDurationTopRespVO> result = dashboardService.getAlarmDurationTop(factoryId, topN);
    ...
    public CommonResult<MetricTrendRespVO> getMetricTrend(
        ...
        MetricTrendRespVO result = dashboardService.getMetricTrend(factoryId, type, startDate, endDate);
        return CommonResult.success(result);
    }
    ...
    @Parameter(name = "factoryId", description = "工厂ID", example = "123456789")
    public CommonResult<List<DeviceListRespVO>> getDeviceList(@RequestParam(value = "factoryId") Long factoryId) {
        List<DeviceListRespVO> result = dashboardService.getDeviceList(factoryId);
        return CommonResult.success(result);
    }
}
