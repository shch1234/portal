package com.weili.iot_portal.business.common.api.shift;
...
public interface ShiftQueryApi {
     ...
     */
    ShiftInfoVO getDeviceCurrentShift(String tenantId, String factoryId, String deviceId, Long timestamp);
     ...
     */
    ShiftInfoVO getFactoryCurrentShift(String tenantId, String factoryId, String workshopId, Long timestamp);
     ...
     * @throws com.weili.basic.common.exception.ServiceException 如果设备未配置班次信息
     */
    ShiftTimeRangeVO calculateShiftRange(String tenantId, String factoryId, String deviceId, Long timestamp);
}
