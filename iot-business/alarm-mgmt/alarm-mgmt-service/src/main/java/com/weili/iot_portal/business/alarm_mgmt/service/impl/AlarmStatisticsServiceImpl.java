...
import com.weili.iot_portal.business.alarm_mgmt.service.AlarmStatisticsService;
import com.weili.iot_portal.business.alarm_mgmt.service.assembler.AlarmStatisticsAssembler;
...
public class AlarmStatisticsServiceImpl implements AlarmStatisticsService {
    ...
    public PageResult<AlarmDeviceItemVO> getCurrentAlarmDeviceList(String tenantId, CurrentAlarmDeviceQueryReq request) {
        ...
        // 转换为VO
        List<AlarmDeviceItemVO> items = AlarmStatisticsAssembler.toDeviceItemVOList(pageResult.getRecords());
