...
@Tag(name = "设备管理-设备指标")
@RestController
@RequestMapping("/api/device-mgmt/v1/devices/{deviceId}/metrics")
...
public class DeviceMetricsController {
    ...
    public CommonResult<DeviceMetricHistoryVO> getCurrentMetrics(@PathVariable String deviceId,
    ...
    public CommonResult<DeviceMetricHistoryVO> getShiftMetrics(@PathVariable String deviceId,
