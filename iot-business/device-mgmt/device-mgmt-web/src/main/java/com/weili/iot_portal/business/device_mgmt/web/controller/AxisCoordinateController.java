...
import com.weili.iot_portal.business.device_mgmt.service.AxisCoordinateService;
...
@Tag(name = "设备管理-运行参数")
@RestController
@RequestMapping("/api/device-mgmt/v1/devices/{deviceId}/axis-coordinates")
...
public class AxisCoordinateController {
    ...
    public CommonResult<AxisCoordinateListVO> getAxisCoordinates(@PathVariable String deviceId) {
