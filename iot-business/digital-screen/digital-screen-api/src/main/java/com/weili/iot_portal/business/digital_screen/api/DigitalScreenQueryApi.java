package com.weili.iot_portal.business.digital_screen.api;
...
public interface DigitalScreenQueryApi {
     ...
     * @return 报警排行
     */
    java.util.List<AlarmRankingVO> getAlarmDurationRanking(String tenantId, String factoryId, Integer limit);
