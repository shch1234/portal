package com.weili.iot_portal.business.efficiency_mgmt.service.assembler;
...
import com.weili.iot_portal.business.efficiency_mgmt.domain.model.FactoryMetricsTrendVO;
import com.weili.iot_portal.business.efficiency_mgmt.domain.model.FactoryMetricsVO;
...
public class FactoryMetricsAssembler {
    ...
    public static FactoryMetricsVO toVO(FactoryMetricsShiftDO current, List<FactoryMetricsShiftDO> history, 
        ...
        FactoryMetricsVO vo = FactoryMetricsVO.builder()
                .factoryId(current != null ? current.getFactoryId() : null)
                .factoryName(factoryName)
                .shiftDate(current != null ? current.getShiftDate() : null)
                .shiftCode(current != null ? current.getShiftCode() : null)
                .shiftName(shiftRange != null ? shiftRange.getShiftName() : null)
                .deviceCount(current != null ? current.getDeviceCount() : 0)
                .isFinalized(current != null ? current.getIsFinalized() : false)
                .build();
