...
import com.weili.iot_portal.business.efficiency_mgmt.service.assembler.FactoryMetricsAssembler;
...
public class FactoryMetricsApiImpl implements FactoryMetricsApi {
        ...
        for (DeviceBaseInfoVO device : devices) {
            try {
                ...
                List<DeviceEfficiencyMetricDO> oeeMetrics = efficiencyMetricRepository.selectDeviceMetrics(
                        ...
                        "metricValue", "DESC", 1, 1).getRecords();
