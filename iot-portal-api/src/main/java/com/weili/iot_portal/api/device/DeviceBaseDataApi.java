...
public interface DeviceBaseDataApi {
     ...
     */
    DeviceBaseInfoVO getDeviceById(String factoryId, String deviceId);
     ...
     * @throws com.weili.basic.common.exception.ServiceException 如果设备不存在或不属于该工厂
     */
    DeviceBaseInfoVO getDeviceByCode(String factoryId, String deviceCode);
     ...
     * @return 设备基础信息列表
     */
    List<DeviceBaseInfoVO> getDevicesByIds(String factoryId, List<String> deviceIds);
     ...
     * @return 设备基础信息列表
     */
    List<DeviceBaseInfoVO> getDevicesByFactory(String factoryId, String workshopId);
     ...
     */
    DeviceBaseInfoVO getDeviceByTbDeviceId(String tbDeviceId);
}
